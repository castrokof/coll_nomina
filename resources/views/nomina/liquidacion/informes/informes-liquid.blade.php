      ...
      <div class="container-fluid">
        <div class="row mb-12">
          ...
          <div class="row col-lg-12">
            ...
            @include('nomina.liquidacion.informes.form')
            ...
            <div class="card-header p-0 pt-1">
              ...
              <div class="tab-content" id="custom-tabs-one-tabContent">
                <div class="tab-pane fade active show" id="custom-tabs-one-datos-del-pago" role="tabpanel" aria-labelledby="custom-tabs-one-datos-del-pago-tab">
                      ...
                      @csrf
                      @include('nomina.liquidacion.informes.form-turnos')
...
$.get('select_quincena',
        ...
        {
            $('#quincena').empty();
            $('#quincena').append("<option value=''>---seleccionar quincena---</option>")
            $.each(quincenas, function(quincena, value){
            $('#quincena').append("<option value='" + value.quincena + "'>" + value.quincena + "</option>")
            });
...
// Función para filtrar cargar los datos en la tabla
 ...
 function fill_datatable_tabla(quincena = '', usuario = '' )
         {
          ...
          ajax:{
               url:"{{route('liquidinfo')}}",
                data:{quincena:quincena, usuario:usuario }
              },
              columns: [
          {data:'action',
           orderable: false},
