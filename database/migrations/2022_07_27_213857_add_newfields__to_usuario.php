...
class AddNewfieldsToUsuario extends Migration
{
    ...
    public function up()
    {
        Schema::table('usuario', function (Blueprint $table) {
            ...
            $table->string('type_contrat', 255)->nullable()->after('cargo_id');
            $table->date('date_in')->nullable()->after('cargo_id');
        });
    }
    ...
    public function down()
    {
        Schema::table('usuario', function (Blueprint $table) {
            ...
            Schema::dropColumn('type_contrat');
            Schema::dropColumn('date_in');
        });
    }
}
