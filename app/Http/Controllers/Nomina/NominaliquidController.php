...
//Function para mostrar datos en el index de turnos
    ...
    public function index(Request $request )
    {
        ...
        if($request->ajax()){
            ...
            ->select('nominaliquids.id as id', 'nominaliquids.date_hour_initial_turn as date_hour_initial_turn', 'nominaliquids.date_hour_end_turn as date_hour_end_turn', 'nominaliquids.hours as hours',
            ...
            ->where([['nominaliquids.user_id', $usuario_id],
